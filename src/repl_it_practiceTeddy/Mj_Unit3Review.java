...
//----------------------------------------------------------------------------------------------------------//
        ...
        System.out.println("nums = " + nums); // one of benefits of ArrayList == allow to print directly - nums = [1, 2, 3, 4, 5]

        // two different method for adding :
        nums.add(3);
        System.out.println(nums.add(3)); //return result is TRUE- boolean
        // it will add value to the last index automatically
        System.out.println("nums after add 3 = " + nums);  //nums after add 3 = [1, 2, 3, 4, 5, 3, 3]

        //
        nums.add(2, 4); // add element into the specific index
        System.out.println("nums = " + nums);   //nums = [1, 2, 4 (number 4 comes at index 2), 3, 4, 5, 3, 3]
        ...
        nums1.remove(2);
        System.out.println("nums1 = " + nums1);  // nums1 = [1, 2, 4, 5]
        System.out.println(nums1.remove(3)); // return the value   //5
        System.out.println("nums1 = " + nums1); // also remove it  //nums1 = [1, 2, 4]
        ...
        System.out.println("words = " + words);  //words = [apple, kiwi]
        words.remove("kiwi");
        System.out.println("words = " + words); // remove specific Object   //words = [apple]
        System.out.println(words.remove("apple")); //  true
        ...
        System.out.println("words2 = " + words2);  //words2 = [mj, mohammad, javad, semati]
        words2.removeAll(words2);
        System.out.println("words2 = " + words2); //words2 = []
        ...
        words2.isEmpty();
        System.out.println(words2.isEmpty());  //true
        ...
        System.out.println(words2.containsAll(words));  //false
        ...
        System.out.println("words2 = " + words2);  //words2 = [mj, mohammad, javad, semati]
        words2.set(2, "orange");
        System.out.println("words2 = " + words2);  //words2 = [mj, mohammad, orange, semati]

        System.out.println(words2.set(1, "ZZZ")); // mohammad -  print mohammad (method returns the original value) and replace it with ZZZ at the same time

        System.out.println("nums = " + nums);  //nums = [1, 2, 4, 3, 4, 5, 3, 3]
        nums.set(2 , 0);
        System.out.println("nums = " + nums); //nums = [1, 2, 0, 3, 4, 5, 3, 3]


        nums.set(nums.indexOf(3) , 10);
        System.out.println("nums = " + nums);  //nums = [1, 2, 0, 10, 4, 5, 3, 3]

        nums.set(nums.indexOf(3) , 10);
        System.out.println("nums = " + nums);   //nums = [1, 2, 0, 10, 4, 5, ????10, 3]

        //        nums.set(nums.indexOf(3) , 10);
        //        System.out.println("nums = " + nums);

        System.out.println("words2 = " + words2);   //words2 = [mj, ZZZ, orange, semati]
        //   words2.set(words2.indexOf(0) , "AAA");
        //   System.out.println("words2 = " + words2);

        words2.set(0 , "aAa");
        System.out.println("words2 = " + words2);  //words2 = [aAa, ZZZ, orange, semati]
...
//        nums4.add(4); // UnsupportedOperationException
        ...
        System.out.println("numbers = " + numbers);  //numbers = [100, -8, -2, 9, 3, 23, 1, 2, 3, 4]
        ...
        System.out.println(nums5.get(2));  //3
        ...
        nums5.remove(3); //
        System.out.println("----------------------");
        System.out.println(nums.remove(3));  //10
        System.out.println(nums);  //[1, 2, 0, 4, 5, 10, 3]
        nums.remove(new Integer(1));
        System.out.println("-----");
        System.out.println(nums.remove(new Integer(6))); //false
        System.out.println(nums); //[2, 0, 4, 5, 10, 3]
        // return boolean
        // (1, 2, 3, 4, 5)
        System.out.println(nums.remove("3")); // false
