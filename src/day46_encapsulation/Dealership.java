...
public class Dealership {
    public static void main(String[] args) {
        Car car1 = new Car ();
        //ERROR below - model and year are PRIVATE and cannot be accessed from another class, they are in Car class
...
//        car1.year = 2020;
        ...
        System.out.println("car mileage = " + car1.getYear());
        ...
        System.out.println(alfaRomeo);  //automatically calls toString
